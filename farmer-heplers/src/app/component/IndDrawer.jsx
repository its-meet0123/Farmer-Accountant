...
import GeneralTransactionForm from "./subcomponent/GeneralTransactionForm";
...
const IndDrawer = ({
  ...
  const onClose = () => {
    ...
    form.resetFields();
    setBtnLoad(false);
    setOpen({ marketType: "grain", openType: null });
  };
  const handleSubmit = async () => {
    setBtnLoad(true);

    if (openType.open === "edit") {
      try {
  ...
  return (
    <>
      <Drawer
        title={
          (openType.open === "edit" && t("indDrawer.drawerForm.titleText1")) ||
          (openType.open === "add" && t("indDrawer.drawerForm.titleText2"))
        }
        getContainer={false}
        placement="right"
        size="large"
        onClose={onClose}
        open={openType.open !== null}
        extra={
          <Space>
            <Button onClick={onClose}>{t("indDrawer.button.cbt")}</Button>
            {openType.open === "edit" && edit === false && (
              <Button onClick={() => setEdit(true)}>Edit</Button>
            )}
          </Space>
        }>
        {openType.marketType === "grain" && (
          <>
            {openType.open == "add" && (
                ...
                <Form
                  ...
                  <Row gutter={24}>
                    <Form.Item
                      ...
                      <InputNumber
                        placeholder={t(
                          "indDrawer.drawerForm.sellItemInput.pt1",
                        )}
                      />
                    </Form.Item>
                    <Form.Item
                      ...
                      <Input
                        placeholder={t(
                          "indDrawer.drawerForm.sellItemInput.pt2",
                        )}
                      />
                    </Form.Item>
                    <Form.Item
                      ...
                      <Input
                        placeholder={t(
                          "indDrawer.drawerForm.sellItemInput.pt3",
                        )}
                      />
                    </Form.Item>
                    <Form.Item
                ...
                <Form
                  ...
                  <Row gutter={24}>
                    ...
                    <Form.Item
                      ...
                      name="handOver">
                      <Input
                        placeholder={t("indDrawer.drawerForm.loanInput.pt3")}
                      />
                    </Form.Item>
                  </Row>
                  <Typography.Title level={5}>
        ...
        <>
          {openType.marketType === "general" && (
            <GeneralTransactionForm form={generalForm} />
          )}
        </>
      </Drawer>
    </>
